...
console.log(`Connecting to ${useHttp2 ? 'HTTP/2' : 'HTTPS/1.1'} streaming server on https://localhost:${port} using fetch`);
...
async function streamWithFetch() {
  try {
    ...
    console.error('Fetch error:', collectErrorMessages(err));
  }
}
